...
router.post('/AgregarCB14/:id',CB14.Crear);
...
router.post('/AgregarCB15/:id',CB15.Crear);
...
router.post('/AgregarCB16/:id',CB16.Crear);
...
router.post('/AgregarCB17/:id',CB17.Crear);
...
router.post('/AgregarCB18/:id',CB18.Crear);
...
router.post('/AgregarCB19/:id',CB19.Crear);
